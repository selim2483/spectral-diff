...
class ConvNextBlock(nn.Module):
    ...
    def __init__(
            self, 
            dim, dim_out, *, emb_dim=None, mult=3, norm=True, 
        ...
        self.net = nn.Sequential(
            ...
            nn.Conv2d(
                dim, dim_out * mult, 3, padding=1, padding_mode=padding_mode),
            nn.GELU(),
            nn.Conv2d(
                dim_out * mult, dim_out, 3, padding=1, padding_mode=padding_mode)
        )
